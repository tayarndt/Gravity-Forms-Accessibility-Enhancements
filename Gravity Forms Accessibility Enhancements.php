...
if (class_exists('GFForms')) {
    ...
    function gf_accessibility_render_submenu() {
        ...
        // Add Form Preview Link if a form is selected
        if($selected_form_id > 0){
            $preview_url = home_url('?gf_page=preview&id=' . $selected_form_id);
            echo '<p><a href="' . esc_url($preview_url) . '" target="_blank">Preview Form</a></p>';
        }
